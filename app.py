...
tableau_code = """
<div id="tableauContainer" style="position: relative; overflow: hidden; border: 1px solid #e0e0e0; border-radius: 8px;">
<div class='tableauPlaceholder' id='viz1738751341715' style='width: 100%; height: 600px;'>
...
(function() {
    ...
    const hideElements = () => {
        // Hide all unwanted elements using advanced selectors
        const elementsToHide = [
            'div.tab-toolbar', 
            'div.tab-public-banner',
            'div.credit-branding',
            'a.tab-edit-button',
            'div.fph',
            'div.tab-zone'
        ...
        // Remove click handlers on the entire container
    ...
    const mutationObserver = new MutationObserver((mutations) => {
        if(document.querySelector('iframe[src*="tableau.com"]')) {
            ...
            style.textContent = `
                ...
                div.tab-widget-toolbar, 
                div.tab-zone, 
                div.tabToastContainer, 
                div.fph { 
            ...
            // Create overlay to intercept interactions
    ...
    // Load Tableau script after cleanup setup
